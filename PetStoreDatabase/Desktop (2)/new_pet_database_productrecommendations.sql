...
CREATE TABLE `productrecommendations` (
  ...
  `Custusername` varchar(255) DEFAULT NULL,
  `ProductID` int DEFAULT NULL,
  PRIMARY KEY (`RecommendationID`),
  KEY `Custusername` (`Custusername`),
  KEY `ProductID` (`ProductID`),
  CONSTRAINT `productrecommendations_ibfk_1` FOREIGN KEY (`Custusername`) REFERENCES `users` (`Custusername`) ON DELETE CASCADE,
