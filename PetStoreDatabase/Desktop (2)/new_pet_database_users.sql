...
INSERT INTO `users` VALUES ('Alice','hash5','alice@example.com'),('Bob','hash6','bob@example.com'),('Charlie','hash7','charlie@example.com'),('Diana','hash8','diana@example.com'),('Evan','hash9','evan@example.com'),('Jeremy','hash4','jeremy@example.com'),('Khoi','hash3','khoi@example.com'),('Nkinnas','hash1','nkinnas@example.com'),('Ryan','hash5','ryans@gmail.com'),('Welden','hash2','welden@example.com');
